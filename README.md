...
- **CampX Integration**: Directly accesses the university's CampX system to retrieve result data.
- **Automated Spreadsheet Retrieval**: Fetches result spreadsheets automatically, saving manual effort.
- **Score Analysis**: detailed analytics to process scores, calculate grades, and generate performance insights.
- **Result Management**: A centralized hub to store and manage academic history.
